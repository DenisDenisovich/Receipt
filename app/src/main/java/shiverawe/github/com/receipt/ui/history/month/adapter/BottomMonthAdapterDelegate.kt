...
class BottomMonthAdapterDelegate(override var viewType: Int): AdapterDelegate<ReceiptMonth> {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder {
        return BottomViewHolder(getLayout(parent, R.layout.item_month_bottom))
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, items: ArrayList<ReceiptMonth>, position: Int) {
        (holder as BottomViewHolder).bind(items[position])
    }
